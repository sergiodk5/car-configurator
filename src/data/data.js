...
export const guarantees = [
  {
    type: 'Αρχική Εγγύηση (Αμάξωμα 2 χρόνια εγγύηση - Μπαταρίες Μολύβδου 1 χρόνο / 10.000 χλμ. - Μπαταρίες Λιθίου 4 χρόνια / 60.000 χλμ.)',
    price: 0,
    add_years: 0,
  },
  {
    type: 'Επέκταση Εγγύησης +1 έτος',
    price: 496,
    add_years: 1,
  },
  {
    type: 'Επέκταση Εγγύησης +2 έτη',
    price: 992,
    add_years: 2,
  },
]

export const payments = ['Μετρητοίς', 'Χρηματοδότηση με Καταναλωτικό Δάνειο']
